...
import br.com.clearsys.professorama.aluno.AtualizaInformacoesAluno;
                ...
                .setPositiveButton(R.string.positiveBtn, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (txtRA != null) {
                            ...
                            Call<Aluno> buscarAlunoRa = new RetrofitConfig().getAlunoRA().buscarAluno(recebeRA);
                            ...
                            Toast.makeText(getActivity(), "Ra não encontrado. ", Toast.LENGTH_LONG).show();
                        }
                    }
                })
